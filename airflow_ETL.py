...
#DAG для ежедневного автозаполнения новой таблицы посчитанными данными за вчерашний день. (выгрузка данных из двух таюлиц, преобразование и загрузка в новую таблицу)
